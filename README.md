...
The following are the different level of testing that have been performed to ensure the quality of the web site.

1) functional Testing
   - Add and remove items in the cart - user should be able to add/remove items from the cart by clicking add/remove buttons.
   - Select same item multiple times - web site should not allow same items multiple times.
   - Display shopping cart real time - shopping cart should display current state of items in the cart.
2)User Testing
   - Check web site responsiveness - web site should display any device or platform without any issues.
   - usability - site should be easy to navigate and contents are clear in the web page.  
   - accessibility - site should be accessible to anyone, and follow the accessibility rules.
3)Performance testing
   - Check performance of the site with different devices.
   - do concurrent testing with multiple users.
   - check site in different timing to see any network issues.
4)Security Testing
   - Check JavaScript in order to avoid vulnerabilities.
   - check the input fields to avoid arbitrary values.  
